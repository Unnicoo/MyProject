...
def get_single_a_t_line(num=0):
    ...
    time_stamps, v_values, a_values = DataProcessing.get_t_v_a_values(file[:])
...
def get_all_x_y_line():
    ...
    for title in titles:
        ...
        x_coordinates, y_coordinates = DataProcessing.get_x_y_values(file[:])
...
if __name__ == '__main__':
    ...
    # _data = DataProcessing.get_same_delta_data(data, 0.4)
