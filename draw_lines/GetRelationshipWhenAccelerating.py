...
if __name__=='__main__':
    for i in range(len(index_minV_maxV_3)):
        title = titles[index_minV_maxV_3[i][0]]
        file = data[title]
        t_values, a_values, v_values = get_time_a_v_values(file)
        selected_v_values, selected_a_values, time_values = select_v_a_t_values(file, index_minV_maxV_3[i][1],
                                                                                index_minV_maxV_3[i][2])
